...
import rpyc
class ChunkServer3(rpyc.Service):
    def __init__(self):
        
        self.local_chunk_table={}
        self.chunkserver_filesystem_loc=os.getcwd()+"/chunkserverdirectory3"
...
if __name__ == "__main__":
    ...
    t = ThreadedServer(ChunkServer3, port=9090)
    t.start()
